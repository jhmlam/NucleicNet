...
if __name__ == '__main__':
	...
	tbd_index = np.where(coarse_label=='purine')[0]
	...
	with open(arg.output+'_purine_score.pickle','wb') as f:
		pickle.dump(prob_test, f)
	df.to_pickle(arg.output+'_result.pickle')
